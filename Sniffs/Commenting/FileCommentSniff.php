...
class Seb_Sniffs_Commenting_FileCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processTags($commentStart, $commentEnd)
    {
        ...
        //SEB - make these tags optional
        $optional = array('subpackage', 'copyright', 'license');
