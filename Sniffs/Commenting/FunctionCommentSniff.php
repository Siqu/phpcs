 ...
 *  <li>---A return type exists-- disabled</li>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Seb_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processReturn($commentStart, $commentEnd)
    {
        ...
        if ($isSpecialMethod === false && $methodName !== $className) {
            ...
            } /* SEB - allow comment without return - actually it is better to check
                 that there is no 'return' in the function body
            } else {
