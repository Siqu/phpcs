 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Seb_Sniffs_Commenting_FunctionCommentThrowTagSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if (empty($throws) === true) {
            /* SEB - allow no tag, it is better to check that there is not throw in function body
